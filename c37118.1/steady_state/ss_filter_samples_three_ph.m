...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [filtered_data] = ss_filter_samples_three_ph(data, lenght_frame_step, filter_nsamples, number_of_step)

  filtered_data = [];
  initial_frame_of_step = 1;
  finish_frame_of_step = lenght_frame_step;
  for i=1:number_of_step
    tmp_data = data(1:3, (initial_frame_of_step+filter_nsamples):(finish_frame_of_step-filter_nsamples) );
